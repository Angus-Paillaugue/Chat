...
<div class="max-w-md mx-auto w-full h-screen flex flex-col justify-center">
    <form class="w-full p-4 bg-white border border-gray-200 rounded-lg shadow sm:p-6 md:p-8 dark:bg-gray-800 dark:border-gray-700 flex flex-col gap-6" on:submit|preventDefault>
        ...
        <div>
            ...
            <input type="text" placeholder="E-mail" name="e-mail" bind:value={email} class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500">
        </div>
        <div>
        ...
        <button class="button-primary w-full" on:click={signIn}>Sign-in</button>
